      ...
      <div className={styles.container}>
        ...
        <div className={styles.benefitsFooter}>
          <p className={styles.benefitsFooterText}>
            Стопи — це фундамент всього тіла. 26 кісток, 33 суглоби, більше сотні м'язів, зв'язок і
            сухожиль — все це щодня тримає нашу вагу, адаптується до взуття, підлоги, асфальту,
            бігових доріжок.
          </p>
          <p className={styles.benefitsFooterText}>
            І кожна дрібна помилка — тісне взуття, неправильна постановка стопи, відсутність
